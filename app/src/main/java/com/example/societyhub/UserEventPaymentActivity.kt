...
class UserEventPaymentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_user_event_payment)
        ...
        if (requestCode == PayUmoneyFlowManager.REQUEST_CODE_PAYMENT && resultCode == RESULT_OK && data != null) {
            ...
            if (transactionResponse.getPayuResponse() != null) {
                if (transactionResponse.transactionStatus
                    ...
                    if (user != null) {
                                if (en != null) {
                                    FirebaseFirestore.getInstance().collection("Members").document(user).collection("received events").document(en).addSnapshotListener { value, error ->
                                        ...
                                        if (model != null) {
                                            ...
                                            FirebaseFirestore.getInstance().collection("Members").document(user).collection("received events").document(en).update(map as Map<String, Any>)
                                            var intent= Intent(this,EventsUserSide::class.java)
                    ...
                    startActivity(Intent(this,AttendEventNotRegisteredUserSide::class.java))
                }
