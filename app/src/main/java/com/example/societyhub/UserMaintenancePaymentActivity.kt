...
class UserMaintenancePaymentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_user_maintenance_payment)
        ...
        if (requestCode == PayUmoneyFlowManager.REQUEST_CODE_PAYMENT && resultCode == RESULT_OK && data != null) {
            ...
            if (transactionResponse.getPayuResponse() != null) {
                if (transactionResponse.transactionStatus
                    ...
                    if (month != null) {
                        FirebaseFirestore.getInstance().collection("Maintenance").document(month).addSnapshotListener { value, error ->
                            ...
                            if (model != null) {
                                ...
                                map.put("paid","Yes")
                                if (user != null) {
                                    FirebaseFirestore.getInstance().collection("Members").document(user).collection("received maintenance").document(month).update(map as Map<String, Any>)
                                }
                                startActivity(Intent(this,MaintenanceUserSide::class.java))
                            }
                        }
                    }
                    ...
                    startActivity(Intent(this,MaintenanceNotPaidUserSide::class.java))
                }
