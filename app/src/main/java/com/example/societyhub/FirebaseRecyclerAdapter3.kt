...
class FirebaseRecyclerAdapter3(var context: Context, rvoptions: FirestoreRecyclerOptions<MaintenanceModel1>):FirestoreRecyclerAdapter<MaintenanceModel1,MaintenanceViewHolder>(rvoptions) {
    ...
    override fun onBindViewHolder(holder: MaintenanceViewHolder, position: Int, model: MaintenanceModel1) {
