 ...
 * Use the [MemberMaintenanceFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MemberMaintenanceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView=view.findViewById(R.id.rv_member_maintenance)
        textInputEditText=view.findViewById(R.id.til_edt_month_member_maintenance_chairman)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_member_maintenance, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MemberMaintenanceFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                MemberMaintenanceFragment().apply {
